<?php
	...
	class Formulario{
		...
		public static function inicioAjax($accion, $contenedor, $referencia=false){
			$params = is_array($accion) ? $accion : Util::getParams(func_get_args());

            $params["enctype"] = "multipart/form-data";
            
            if(!$referencia) $referencia = rand(0,9999999);
        ...
        public static function mayusculas($nombre, $valor=""){
            ...
            $params["value"] = strtoupper(utf8_encode($valor));
			$params["data-error-type"] = "inline";
		...
		public static function rfc($nombre, $valor=""){
            $params = is_array($nombre) ? $nombre : Util::getParams(func_get_args());
        ...
        public static function select($nombre, $opciones=array(), $seleccion=""){
			...
			$tmp = array();
			if($opciones) foreach($opciones as $key => $value){
				$tmp[utf8_encode($key)] = $value;
			}
        ...
        public static function selectEstados($nombre, $valor=""){
            ...
            $params["selected"] = utf8_encode($valor);
            ...
            $params[1] = array(
                ...
                "DURANGO" => "DURANGO",
                utf8_encode("ESTADO DE MÉXICO") => "ESTADO DE MÉXICO",
                "GUANAJUATO" => "GUANAJUATO",
                "GUERRERO" => "GUERRERO",
                "HIDALGO" => "HIDALGO",
                "JALISCO" => "JALISCO",
                utf8_encode("MICHOACÁN") => "MICHOACÁN",
                "MORELOS" => "MORELOS",
                "NAYARIT" => "NAYARIT",
                utf8_encode("NUEVO LEÓN") => "NUEVO LEÓN",
                "OAXACA" => "OAXACA",
                "PUEBLA" => "PUEBLA",
                utf8_encode("QUERÉTARO") => "QUERÉTARO",
                "QUINTANA ROO" => "QUINTANA ROO",
                utf8_encode("SAN LUIS POTOSÍ") => "SAN LUIS POTOSÍ",
                "SINALOA" => "SINALOA",
                "SONORA" => "SONORA",
                "TABASCO" => "TABASCO",
