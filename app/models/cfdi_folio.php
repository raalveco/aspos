<?php
	class CfdiFolio extends ActiveRecord{
		public static function registrar($serie, $numero_aprobacion, $fecha_recepcion, $inicial, $final, $actual, $tipo_documento = "FACTURA"){
			if(CfdiFolio::existe("cuenta_id = '".Session::get("cuenta_id")."' AND serie = '".$serie."' AND numero_aprobacion = '".$numero_aprobacion."'")){
				return CfdiFolio::consultar("cuenta_id = '".Session::get("cuenta_id")."' AND serie = '".$serie."' AND numero_aprobacion = '".$numero_aprobacion."'");
			}
